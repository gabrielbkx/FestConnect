...
public class ArmazenamentoService {
    ...
    public String salvarMidias(MultipartFile arquivo) {
        ...
        //"Balde" onde vamos colocar a imagem processada antes de enviar para o S3
        ByteArrayOutputStream bytesSaida = new ByteArrayOutputStream();

        //Processamento da imagem usando Thumbnailator para redimensionar, converter para JPG e ajustar a qualidade
        try {
